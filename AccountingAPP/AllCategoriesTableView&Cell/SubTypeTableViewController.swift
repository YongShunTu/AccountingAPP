...
protocol SubTypeTableViewControllerDelegate {
...
class SubTypeTableViewController: UITableViewController {
    ...
    var delegate: SubTypeTableViewControllerDelegate?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.itemsPhoto.image = UIImage(named: itemsImageName)
        // Configure the cell...
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.getSubTypeString(items[indexPath.row])
...
//            subTypeString = SubTypeTableViewController.items[row]
//        }
//
//    }
