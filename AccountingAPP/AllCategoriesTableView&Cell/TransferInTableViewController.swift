//
//  TransferInTableViewController.swift
//  AccountingAPP
//
...
protocol TransferInTableViewControllerDelegate {
    func getTransferInString(_ transferInString: String)
}


class TransferInTableViewController: UITableViewController {

    var items: [String] = []
    
    var transferInString = ""
    
    var delegate: TransferInTableViewControllerDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.getTransferInString(items[indexPath.row])
