...
class ExpenditureViewController: UIViewController {
    ...
    var categoryString: String = "" {
        didSet {
            ...
            subTypeString = (expenditureSubTypeItems[categoryString]?.first) ?? ""
        }
    }
    ...
    @IBAction func categoryButtonClicked(_ sender: UIButton) {
        CategoryTableViewController.items = expenditureCategoryItems
    }
    
    @IBAction func subTypeButtonClicked(_ sender: UIButton) {
        SubTypeTableViewController.itemsImageName = categoryString
        SubTypeTableViewController.items = expenditureSubTypeItems[categoryString]!
    }
    ...
    @IBAction func addExpenditure(_ sender: UIButton) {
        ...
        self.account = Account(expenditrueOrIncome: "expenditure", imageName: imageName, money: money, date: data, category: category, subtype: subtype, note: note, billNumber: billNumber, project: project, location: location)
        //        }
    }
